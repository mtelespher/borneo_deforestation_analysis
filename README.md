...
## Overview
The aim of thia analysis is to use remote sensing and unsupervised machine learning to detect deforestation from satellite imagery. This allows us to conduct a time and cost-efficient analysis of an area which is a critical intersection of inreasing palm oil expansion and a habitat loss for a wide range of biodiversity.
