...
## Overview
The aim of this project is to use remote sensing and unsupervised machine learning to detect deforestation from satellite imagery. This enables a time and cost-efficient analysis of an area which is a critical intersection of inreasing palm oil expansion and a habitat loss for a wide range of biodiversity. It also aims to prove the effectiveness of unsupervised learning methods in tracking forest cover loss.
